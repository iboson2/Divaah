					...
					<div class="col-lg-12"> 
						<div class="panel">
							<div class="panel-title no-border bg-white">
								<div class="panel-head"><i class="ion-arrow-graph-up-right"></i>Registered Users</div>
...
if(isset($_GET['remb'])){
		...
		$product = $db_handle->runQuery("DELETE FROM users  WHERE userId = '".$idf."' and userEmail = '".$idg."'");
...
?>													
	    ...
	    $id=$product_array[$key]["userId"];
        $nam=$product_array[$key]["userName"];	
		$lm=$product_array[$key]["lastName"];
        $em=$product_array[$key]["userEmail"];
        $ph=$product_array[$key]["userph"];		
		...
		?>			
										...
										<td style=" border:1px solid #000; text-align:center;"><?=$lm ?></td>
										<td style=" border:1px solid #000; text-align:center;"><?=$em ?></td>
										<td style=" border:1px solid #000; text-align:center;"><?=$ph ?></td>										
										<form action="user.php" method="get">
										<input type="hidden" name="ids" value="<?= $id ?>">
										<input type="hidden" name="em" value="<?= $em ?>">
										
<td style=" border:1px solid #000; text-align:center;"><button type="submit" name="remb" style="background-color: Transparent;"><i class="ion-close"></i></button></td>
</form>
...
?>	
		<tr style=" border:1px solid #000; text-align:center; color:black;">
