...
<body class="fixed-leftside fixed-header">
	...
	<div class="wrapper">
					...
					<ul class="nav-sidebar">
                        ...
                        <li class="nav-dropdown active open">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="divaah_daily_kurti.php">Kurti</a></li>
        ...
        <div class="rightside bg-grey-100">
			...
			<br><br>
            <div class="page-head">
				<h1 class="page-title">Daily Wears<small>Update product details here.</small></h1>
				<!-- BEGIN BREADCRUMB -->
				<ol class="breadcrumb">
					<li><a href="index.php"><i class="ion-navicon-round margin-right-5"></i> Dashboard</a></li>
					<li>Daily Wears</li>
					<li class="active">Kurti</li>
				</ol>
				<!-- END BREADCRUMB -->
			</div>
			<!-- END PAGE HEADING -->
	...
	<?php
	    ...
	    $product_array = $db_handle->runQuery("SELECT * FROM image where ID = '12'");
...
if(isset($_FILES['uploaded_file'])) {
    ...
    if($_FILES['uploaded_file']['error'] == 0) {
        ...
        if($result){
            header("Location: divaah_daily_kurti.php");
        }
        else {
