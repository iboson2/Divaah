...
$sql = "SELECT count(*) as count FROM product  WHERE Grp = 6 " ;
try {
    $stmt = $DB->prepare($sql);
    $stmt->execute();
...
if($a==8){
$sql2 = " SELECT * FROM product WHERE Grp = 6 limit ". ($lower_limit)." ,  ". ($page_limit). " ";
}
if($a==7){
$sql2 = " SELECT * FROM product WHERE Grp = 6 order by ID  DESC limit ". ($lower_limit)." ,  ". ($page_limit). " ";
}
if($a==9){
$sql2 = " SELECT * FROM product WHERE Grp = 6  ORDER BY CAST(Price as SIGNED INTEGER)  DESC limit ". ($lower_limit)." ,  ". ($page_limit). " ";
}
if($a==15){
$sql2 = " SELECT * FROM product WHERE Grp = 6 ORDER BY CAST(Price as SIGNED INTEGER)  ASC limit ". ($lower_limit)." ,  ". ($page_limit). " ";
}
if($a==20){
$sql2 = " SELECT * FROM product WHERE Grp = 6 order by ID  DESC limit ". ($lower_limit)." ,  ". ($page_limit). " ";
}
