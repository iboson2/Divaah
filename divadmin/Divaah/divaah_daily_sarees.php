...
<body class="fixed-leftside fixed-header">
					...
					<ul class="nav-sidebar">
                        ...
                        <li class="nav-dropdown active open">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="divaah_daily_sarees.php">Sarees</a></li>
	...
	<?php
	    ...
	    $product_array = $db_handle->runQuery("SELECT * FROM image where ID = '13'");
...
if(isset($_FILES['uploaded_file'])) {
    ...
    if($_FILES['uploaded_file']['error'] == 0) {
        ...
        if($result){
            header("Location: divaah_daily_sarees.php");
        }
        else {
