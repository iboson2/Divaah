...
<body class="fixed-leftside fixed-header">
	...
	<div class="wrapper">
					...
					<ul class="nav-sidebar">
                       ...
                       <li class="nav-dropdown">
                        ...
                        <li class="nav-dropdown active open">
                            ...
                            <ul>
								<li class="active"><a href="divaah_party.php">Party Wears</a></li>
        ...
        <div class="rightside bg-grey-100">
			...
			<br><br>
            <div class="page-head">
				<h1 class="page-title">Party Wears<small>Update all page details here.</small></h1>
				<!-- BEGIN BREADCRUMB -->
				<ol class="breadcrumb">
					<li><a href="index.php"><i class="ion-home margin-right-5"></i> Dashboard</a></li>
					<li class="active">Party Wears</li>
				</ol>
				<!-- END BREADCRUMB -->
			</div>
			<!-- END PAGE HEADING -->
...
<?php
		    $product_array = $db_handle->runQuery("SELECT * FROM image where ID = '18'");
...
if(isset($_FILES['uploaded_file'])) {
    ...
    if($_FILES['uploaded_file']['error'] == 0) {
        ...
        if($result){
            header("Location: divaah_party.php");
        }
        else {
...
?>							
							<div class="panel-body">
								...
								<form  action="divaah_party.php" method="post" enctype="multipart/form-data" ><br>								
	...
	<?php
	    ...
	    $product_array = $db_handle->runQuery("SELECT * FROM image where ID = '10'");
	    if (!empty($product_array)) { 
	    foreach($product_array as $key=>$value){
...
?>							
							<div class="panel-body">
								<h3 class="color-grey-700 margin-top-10">Sub Category Image (Salwars)</h3>
								<p class="text-light margin-bottom-30">Drag’n’drop the Sub Category Image (Salwars).</p>
...
<?php
	    ...
	    $product_array = $db_handle->runQuery("SELECT * FROM image where ID = '11'");
	    if (!empty($product_array)) { 
	    foreach($product_array as $key=>$value){
			$ie=$product_array[$key]["ID"];
	    $bosd=$product_array[$key]["Name"];
