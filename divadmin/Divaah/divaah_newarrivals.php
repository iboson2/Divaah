...
<body class="fixed-leftside fixed-header">
	...
	<div class="wrapper">
					...
					<ul class="nav-sidebar">
						...
						<li>
							<a href="divaah_newarrivals.php">
								<i class="ion-beaker" class="active"></i> <span>New Arrivals</span>
							</a>
						</li>
						<li>
        ...
        <div class="rightside bg-grey-100">
			...
			<br><br>
            <div class="page-head">
				<h1 class="page-title">New Arrivals<small>Update product details here.</small></h1>
				<!-- BEGIN BREADCRUMB -->
				<ol class="breadcrumb">
	...
	<?php
	    ...
	    $product_array = $db_handle->runQuery("SELECT * FROM image where ID = '16'");
...
if(isset($_FILES['uploaded_file'])) {
    ...
    if($_FILES['uploaded_file']['error'] == 0) {
        ...
        if($result){
            header("Location: divaah_newarrivals.php");
        }
        else {
