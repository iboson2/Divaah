...
<body class="fixed-leftside fixed-header">
	...
	<div class="wrapper">
        ...
        <div class="rightside bg-grey-100">
			...
			<br><br>
            <div class="page-head">
				<h1 class="page-title">Footer<small>Update footer details here.</small></h1>
				<!-- BEGIN BREADCRUMB -->
				<ol class="breadcrumb">
...
if(isset($_GET['updated'])){
		...
		$product = $db_handle->runQuery("UPDATE contact SET about='$dataa' WHERE ID = '1' ");
		...
		echo"ddddddddddddd";	
			...
			header("Location: divaah_footer.php");
			}
...
?>
							...
							<div class="panel-body">
								<h3 class="color-grey-700 margin-top-10">About Us</h3>
								<p class="text-light margin-bottom-30">Remove / add 'About Us'</p>
											
								<form role="form" action="divaah_footer.php" method="get">
									<div class="form-group">
										<textarea class="form-control bs-texteditor" name="abas" rows="7" placeholder="<?= $ab ?>"></textarea>
									</div>
...
if(isset($_GET['updateda'])){
		...
		$product = $db_handle->runQuery("UPDATE contact SET phone='$datab', email='$datac' WHERE ID = '1' ");
							...
							<div class="panel-body">
								...
								<form role="form" action="divaah_footer.php" method="get">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="phas" id="input-text" placeholder="<?= $ph ?>">
									</div>
									
									<div class="form-group">
										<label for="input-text" class="control-label"><a href="#" ><i class="fa fa-envelope"></i> Mail ID</a></label>
										<input type="text" class="form-control" name="emas" id="input-text" placeholder="<?= $em ?>">
									</div>
									
									<button type="submit" name="updateda" class="btn btn-success">Update</button>
								</form>
							</div>
	<?php
if(isset($_GET['updatedc'])){
		...
		$product = $db_handle->runQuery("UPDATE contact SET fb='$datad', tw='$datae', ig='$dataf' WHERE ID = '1' ");
...
?>						
							<div class="panel-body">
								<h3 class="color-grey-700 margin-top-10">Social Links</h3>
								<p class="text-light margin-bottom-30">Add / Edit your social links</p>
											
								<form role="form" action="divaah_footer.php" method="get">
									<div class="form-group">
										<label for="input-text" class="control-label"><a href="#facebook-official" ><i class="fa fa-facebook"></i> Facebook</a></label>
										<input type="text" class="form-control" name="fbas" id="input-text" placeholder="<?= $fb ?>">
									</div>
									
									<div class="form-group">
										<label for="input-text" class="control-label"><a href="#facebook-official" ><i class="fa fa-instagram"></i> Instagram</a></label>
										<input type="text" class="form-control" name="twas" id="input-text" placeholder="<?= $tw ?>">
									</div>
									
									<div class="form-group">
										<label for="input-text" class="control-label"><a href="#facebook-official" ><i class="fa fa-twitter"></i> Twitter</a></label>
										<input type="text" class="form-control" name="igas" id="input-text" placeholder="<?= $ig ?>">
									</div>
