...
<?php
					...
					<div class="col-lg-12"> 
						<div class="panel">
							<div class="panel-title no-border bg-white">
								<div class="panel-head"><i class="ion-arrow-graph-up-right"></i> Customer Details</div>
    ...
    document.body.innerHTML = originalContents;
							...
							<div class="panel-body padding-top-5">
								<div class="row">
									<div class="col-lg-12">
										...
										<td style=" border:1px solid #000;">Email ID</td>
										<td style=" border:1px solid #000;">Address Line 1</tds>
										<td style=" border:1px solid #000;">Address Line 2</td>
										<td style=" border:1px solid #000;">Region</td>
										<td style=" border:1px solid #000;">City</td>
										<td style=" border:1px solid #000;">Pincode</td>
										<td style=" border:1px solid #000;">Country</td>
										<td style=" border:1px solid #000;">Amount</td>
										<td style=" border:1px solid #000; ">Status</td>
										<td style=" border:1px solid #000;">Payment ID</td>
										<td style=" border:1px solid #000;">Payment Request ID</td>
										</tr>
							<?php
		$product_array = $db_handle->runQuery("SELECT * FROM pro");
	    if (!empty($product_array)) { 
	    foreach($product_array as $key=>$value){
		$idx=$product_array[$key]["id"];
	    $nam=$product_array[$key]["nam"];
        $las=$product_array[$key]["las"];	
		...
		$amount =$product_array[$key]["amount"];
		$phone =$product_array[$key]["phone"];
		$status =$product_array[$key]["status"];
		$preq =$product_array[$key]["preq"];
		$pid =$product_array[$key]["pid"];
		
	    if (!empty($status)) {
		?>			
										<tr>
										<td style=" border:1px solid #000;"><?=$idx ?></td>
										<td style=" border:1px solid #000;"><?=$nam ?>&nbsp;<?=$las ?></td>
										<td style=" border:1px solid #000;"><?=$phone ?></td>
										<td style=" border:1px solid #000;"><?=$em ?></td>
										<td style=" border:1px solid #000;"><?=$saa ?></td>
										<td style=" border:1px solid #000;"><?=$sab ?></td>
										<td style=" border:1px solid #000;"><?=$reg ?></td>
										<td style=" border:1px solid #000;"><?=$cty ?></td>
										<td style=" border:1px solid #000;"><?=$pin ?></td>
										<td style=" border:1px solid #000;"><?=$cnt ?></td>
										<td style=" border:1px solid #000;"><?=$amount ?>.00</td>
										<?php if( $status == "Credit"){  ?>
										<td style=" border:1px solid #000; color:blue;"><?=$status ?></td>
										<?php } else{ ?>
										<td style=" border:1px solid #000; color:red;"><?=$status ?></td>
										<?php } ?>
										<td style=" border:1px solid #000;"><?=$preq ?></td>
										<td style=" border:1px solid #000;"><?=$pid ?></td>
										</tr>
		<?php
			}
		    }
