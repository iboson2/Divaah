...
<div><a id=btnEmpty href="dailysarees.php?action=empty" href=javascript:; class=simpleCart_empty onclick=resetForm(this.form)>
Empty Cart
</a></div>
<?php } ?>
...
<div class=clearfix><span class=cart_subtotal>bag subtotal: <b>&nbsp;<i class="fa fa-inr"></i>&nbsp; <?=$prd ?></b></span></div>
<div>
<a id=btnEmpty href="dailysarees.php?go=empty" href=javascript:; class=simpleCart_empty onclick=resetForm(this.form)>
Empty Cart
</a></div>
...
<?php $product_array=$db_handle->runQuery("SELECT * FROM image where ID = '13'");
if (!empty($product_array)) {
foreach($product_array as $key=>$value){
...
<p><font size=1px>HOME / DAILY WEARS > SAREES<font></p>
</div>
</div>
<script src=jquery-1.9.0.min.js></script>
<script type=text/javascript>function displayRecords(a,b){$.ajax({type:"GET",url:"subcatb.php",data:"show="+a+"&pagenum="+b,cache:false,beforeSend:function(){$(".loader").html('<img src="loader.gif" alt="" width="24" height="24" style="padding-left: 400px; margin-top:10px;" >')},success:function(c){$("#results").html(c);$(".loader").html("")}})}function changeDisplayRowCount(a){displayRecords(a,1)}$(document).ready(function(){displayRecords(8,1)});</script>
<div class="sorting_options clearfix">
<div class=count_tovar_items>
<p>Sarees</p>
</div>
