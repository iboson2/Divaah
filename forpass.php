...
?>	
 ...
 if( isset($_POST['btn-login']) ) { 
  ...
  // if there's no error, continue to login
   ...
   $password =  $user; // password hashing using SHA256
  
   $res=mysql_query("SELECT * FROM users WHERE userName='$user' or userEmail='$user'");
...
<br>
<u><b>
<p>You have requested for a  password to login. Please use the password below to log in.</p>
<p>Divaah Password</p></b></u>
...
<p>While you cannot reply to this email, please feel free to write to us with any queries at support@divaah.com</p>
";
	...
	if($retval== true){
     ...
     $errMSG = "Password has been sent to your registered E-mail Id";
	 echo $errMSG;
...
?>			
				<div class="my_account_block clearfix">
					<div class="login">
						<h2 style="color: #f9af46;">Please Enter Your E-mail Id Here</h2>
						<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" >
<input type="text" name="user" placeholder="Registered Email Id" onFocus="if (this.value == 'Username or email') this.value = '';" onBlur="if (this.value == '') this.value = 'Username or email';" required />
<input  type="hidden" name="pass" value="1" placeholder="Password" onFocus="if (this.value == 'Password') this.value = '';" onBlur="if (this.value == '') this.value = 'Password';" required />
<br><br><br>
							
							<div class="center"><input name="btn-login" type="submit" value="Get Password"></div>
						</form>
					</div>
					<div class="new_customers">
						<h2 style="color: #f9af46;">NEW CUSTOMERS</h2>
						<p>Register with Divaah by Devika to enjoy personalized services</p>
			...
			<div class="copyright" style="background-color:#5a3814;">
				...
				<div class="container clearfix">
					...
					<div class="copyright_inf">
						<span>Design and Developed by <a href="https://ibosoninnov.com">I-Boson Innovations</span> |
