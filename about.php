...
<?php echo $item["price"]; ?></span><a href="about.php?action=remove&code=<?php echo $item["code"]; ?>"><span></span> <i>Remove</i></a>
</li>
</ul>
...
<div><a id=btnEmpty href="about.php?action=empty" href=javascript:; class=simpleCart_empty onclick=resetForm(this.form)>
Empty Cart
</a></div>
<?php
...
<a href=dailysarees.php class=cart_item_title><?php echo $item["name"]; ?></a>
<span class=cart_item_price><?php echo $item["quantity"]; ?> × &nbsp;<i class="fa fa-inr"></i>&nbsp;
<?php echo $item["price"]; ?></span><a href="about.php?go=remove&code=<?php echo $item["code"]; ?>"><span></span><i>Remove</i></a>
</li>
</ul>
<?php
...
<div class=clearfix><span class=cart_subtotal>bag subtotal: <b>&nbsp;<i class="fa fa-inr"></i>&nbsp; <?=$prd ?></b></span></div>
<div>
<a id=btnEmpty href="about.php?go=empty" href=javascript:; class=simpleCart_empty onclick=resetForm(this.form)>
Empty Cart
</a></div>
<?php
...
<li class=sub-menu><a href=contact.php>CONTACT US</a></li>
		...
		<section class="about_us_info">
			...
			<div class="container">
				...
				<!-- ROW -->
				<?php
	    $product_array = $db_handle->runQuery("SELECT * FROM about where ID = '1'");
	    if (!empty($product_array)) { 
	    foreach($product_array as $key=>$value){	    
        $logx=base64_encode($product_array[$key]['imga']);	 
	    $abac=mysql_real_escape_string($product_array[$key]["para"]);
        $abbc=$product_array[$key]["parb"];
		$abcc=$product_array[$key]["parc"];		
		?>
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 padbot60 about_us_description" data-appear-top-offset='-100' data-animated='fadeInLeft'>
						<b><span><?= stripslashes( $abac); ?></span>
						<span><?= stripslashes($abbc); ?></span>
						<span><?= stripslashes($abcc); ?></span></b>
					</div>
					
					<div class="col-lg-6 col-md-6 col-sm-6 padbot30" data-appear-top-offset='-100' data-animated='fadeInRight'>						
						<?php  echo"<img  alt='Divaah by Devika' class='about_img1' src='data:image/jpeg;base64,$logx' >";?>
					</div>
				</div><!-- //ROW -->
				<?php
