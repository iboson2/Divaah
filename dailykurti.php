...
<a href=dailykurti.php class=cart_item_title><?php echo $item["name"]; ?></a>
...
<div><a id=btnEmpty href="dailykurti.php?action=empty" href=javascript:; class=simpleCart_empty onclick=resetForm(this.form)>
Empty Cart
</a></div>
<?php } ?>
...
<div class=clearfix><span class=cart_subtotal>bag subtotal: <b>&nbsp;<i class="fa fa-inr"></i>&nbsp; <?=$prd ?></b></span></div>
<div>
<a id=btnEmpty href="dailykurti.php?go=empty" href=javascript:; class=simpleCart_empty onclick=resetForm(this.form)>
Empty Cart
</a></div>
...
<h3>SHOP BY SIZE</h3>
<ul>
<li><a onclick=changeDisplayRowCount(28) class=sizeS href=javascript:void(0)>S</a></li>
<li><a onclick=changeDisplayRowCount(29) class=sizeM href=javascript:void(0)>M</a></li>
<li><a onclick=changeDisplayRowCount(30) class=sizeL href=javascript:void(0)>L</a></li>
<li><a onclick=changeDisplayRowCount(31) class=sizeXL href=javascript:void(0)>XL</a></li>
<li><a onclick=changeDisplayRowCount(32) class=sizeXXL href=javascript:void(0)>XXL</a></li>
</ul>
</div>
...
<?php $product_array=$db_handle->runQuery("SELECT * FROM image where ID = '12'");
if (!empty($product_array)) {
foreach($product_array as $key=>$value){
...
<p><font size=1px>HOME / DAILY WEARS > KURTI<font></p>
</div>
</div>
<script src=jquery-1.9.0.min.js></script>
<script type=text/javascript>function displayRecords(a,b){$.ajax({type:"GET",url:"subcat.php",data:"show="+a+"&pagenum="+b,cache:false,beforeSend:function(){$(".loader").html('<img src="loader.gif" alt="" width="24" height="24" style="padding-left: 400px; margin-top:10px;" >')},success:function(c){$("#results").html(c);$(".loader").html("")}})}function changeDisplayRowCount(a){displayRecords(a,1)}$(document).ready(function(){displayRecords(8,1)});</script>
<div class="sorting_options clearfix">
<div class=count_tovar_items>
<p>kurti</p>
</div>
